...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
    ...
    let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "512411347465-512411719888@g.us","inviteCode": "m","groupName": "P", "caption": '𝚃𝚑𝚎- Chica - 𝙱𝚘𝚝', 'jpegThumbnail': null}}}
