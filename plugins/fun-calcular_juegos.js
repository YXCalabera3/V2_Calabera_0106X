...
conn.sendHydrated(m.chat, juego, wm, null, md, '❍͜͡➣La Calabera Maldita❍͜͡➣', null, null, [
['🎮𝐆𝐀𝐌𝐄', '/juegosdelgrupo'],
...
conn.sendHydrated(m.chat, juego, wm, null, md, '❍͜͡➣La Chica Bot❍͜͡➣', null, null, [
['🎮𝐆𝐀𝐌𝐄', '/juegosdelgrupo'],
['𝐎𝐓𝐑𝐀 𝐕𝐄𝐙🤭', `${usedPrefix + command} ${text.toUpperCase()}`],
['𝐌𝐄𝑵𝑼️', '/menu'],
], m, m.mentionedJid ? {
...
if (command == 'puta') {
let juego = `_*${text.toUpperCase()}* *ES/IS* *${(1000).getRandom()}%* *${command.replace('how', '').toUpperCase()},* *MÁS INFORMACIÓN A SU PRIVADO 🔥🥵 XD*_`.trim()
conn.sendHydrated(m.chat, juego, wm, null, md, '❍͜͡➣La Calabera❍͜͡➣', null, null, [
['🎮𝐆𝐀𝐌𝐄', '/juegosdelgrupo'],
['𝐎𝐓𝐑𝐀 𝐕𝐄𝐙🤭', `${usedPrefix + command} ${text.toUpperCase()}`],
['𝐌𝐄𝑵𝑼️', '/menu'],
], m, m.mentionedJid ? {
